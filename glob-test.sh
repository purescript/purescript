...
EXPECTED=$(purs compile --output z/out1 z/Foo.purs z/src/**/*.purs z/test/**/*.purs)
SOURCE_GLOBS=$(purs compile  --output z/out2 --source-globs z/globsAll)
MIXED_ALL=$(purs compile  --output z/out3 --source-globs z/globsAll z/Foo.purs)
MIXED_NO_FOO=$(purs compile  --output z/out4 --source-globs z/globsNoFoo z/Foo.purs)
