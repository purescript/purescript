...
derive via (Tuple w) instance monadTellMyWriter :: Monoid w => MonadTell w (MyWriter w)
derive via (Tuple w) instance monadWriterMyWriter :: Monoid w => MonadWriter w (MyWriter w)
