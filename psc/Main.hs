...
compile :: P.Options -> Maybe [FilePath] -> Maybe FilePath -> Maybe FilePath -> Bool -> IO ()
compile opts input output externs noPrefix'= do
      ...
      case P.compile opts (map snd ms) prefix of
        ...
        Right (js, exts, _) -> do
          ...
          case externs of
            ...
            Nothing -> return ()
          exitSuccess
    where prefix = case noPrefix' of
                      True -> Nothing
                      False -> Just("Generated by psc Version " ++ showVersion Paths.version  ++ "\n")
...
noPrefix = value $ flag $ (optInfo ["no-prefix" ])
     { optDoc = "do not prefix output with ' " ++ p ++ "'"}
    where 
      p = "// Generated by psc Version " ++ showVersion Paths.version  ++ "\n"        
...
term prelude = compile <$> options <*> stdInOrInputFiles prelude <*> outputFile <*> externsFile <*> noPrefix
