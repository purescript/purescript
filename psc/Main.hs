...
compile :: P.Options -> Maybe [FilePath] -> Maybe FilePath -> Maybe FilePath -> String -> IO ()
compile opts input output externs prefix' = do
...
prefix :: Term String
prefix = value $ opt p $ (optInfo [ "prefix" ])
     { optDoc = "prefix output with a string, default:" ++ p }
    where 
...
term prelude = compile <$> options <*> stdInOrInputFiles prelude <*> outputFile <*> externsFile <*> prefix
