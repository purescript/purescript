...
compile outputDir opts input = do
  ...
  case modules of
    Left err -> do
      ...
      exitFailure
    Right ms -> do
      e <- runMake $ P.make outputDir opts ms ver
      case e of
        Left err -> do
          U.putStrLn err
          exitFailure
...
options = P.Options <$> noPrelude <*> noTco <*> performRuntimeTypeChecks <*> noMagicDo <*> pure Nothing <*> noOpts <*> pure Nothing <*> pure [] <*> pure [] <*> verboseErrors <*> generatedBy
