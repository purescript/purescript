    ...
    Right ms -> do
      ...
      case e of
        ...
        Right _ -> do
          exitSuccess
    where
      prefix = "// Generated by psc-make Version " ++ showVersion Paths.version ++ "\n"          
...
noGeneratedBy = value $ flag $ (optInfo [ "no-generated-by" ])
     { optDoc = "not prefix output with a 'Generated by psc-make version X.Y.Z' comment" }

options :: Term P.Options
options = P.Options <$> noPrelude <*> noTco <*> performRuntimeTypeChecks <*> noMagicDo <*> pure Nothing <*> noOpts <*> pure Nothing <*> pure [] <*> pure [] <*> verboseErrors <*> noGeneratedBy
