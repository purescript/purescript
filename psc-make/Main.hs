...
compile :: FilePath -> P.Options -> [FilePath] -> String -> IO ()
compile outputDir opts input prefix' = do
...
term prelude = compile <$> outputDirectory <*> options <*> inputFilesAndPrelude prelude <*> prefix
