...
buildMakeActions outputDir filePathMap foreigns usePrefix =
    MakeActions getInputTimestampsAndHashes getOutputTimestamp readExterns codegen codegenJS ffiCodegen progress readCacheDb writeCacheDb writePackageJson outputPrimDocs
  where
