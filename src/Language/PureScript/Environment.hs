...
primCoerceClasses =
  M.fromList
    ...
    [ (primSubName C.moduleCoerce "Coercible", makeTypeClassData
        [ ("a", Just (tyVar "k"), IsVtaTypeVar False)
        , ("b", Just (tyVar "k"), IsVtaTypeVar False)
        ] [] [] [] True)
    ]
...
primRowClasses =
  M.fromList
    ...
    [ (primSubName C.moduleRow "Union", makeTypeClassData
        [ ("left", Just (kindRow (tyVar "k")), IsVtaTypeVar False)
        , ("right", Just (kindRow (tyVar "k")), IsVtaTypeVar False)
        , ("union", Just (kindRow (tyVar "k")), IsVtaTypeVar False)
        ] [] []
    ...
    , (primSubName C.moduleRow "Nub", makeTypeClassData
        [ ("original", Just (kindRow (tyVar "k")), IsVtaTypeVar False)
        , ("nubbed", Just (kindRow (tyVar "k")), IsVtaTypeVar False)
        ] [] []
    ...
    , (primSubName C.moduleRow "Lacks", makeTypeClassData
        [ ("label", Just kindSymbol, IsVtaTypeVar False)
        , ("row", Just (kindRow (tyVar "k")), IsVtaTypeVar False)
        ] [] [] [] True)
    ...
    , (primSubName C.moduleRow "Cons", makeTypeClassData
        [ ("label", Just kindSymbol, IsVtaTypeVar False)
        , ("a", Just (tyVar "k"), IsVtaTypeVar False)
        , ("tail", Just (kindRow (tyVar "k")), IsVtaTypeVar False)
        , ("row", Just (kindRow (tyVar "k")), IsVtaTypeVar False)
        ] [] []
...
primRowListClasses =
  M.fromList
    ...
    [ (primSubName C.moduleRowList "RowToList", makeTypeClassData
        [ ("row", Just (kindRow (tyVar "k")), IsVtaTypeVar False)
        , ("list", Just (kindRowList (tyVar "k")), IsVtaTypeVar False)
        ] [] []
        [ FunctionalDependency [0] [1]
        ] True)
    ]
...
primSymbolClasses =
  M.fromList
    ...
    [ (primSubName C.moduleSymbol "Append", makeTypeClassData
        [ ("left", Just kindSymbol, IsVtaTypeVar False)
        , ("right", Just kindSymbol, IsVtaTypeVar False)
        , ("appended", Just kindSymbol, IsVtaTypeVar False)
        ] [] []
        [ FunctionalDependency [0, 1] [2]
        , FunctionalDependency [1, 2] [0]
        , FunctionalDependency [2, 0] [1]
    ...
    , (primSubName C.moduleSymbol "Compare", makeTypeClassData
        [ ("left", Just kindSymbol, IsVtaTypeVar False)
        , ("right", Just kindSymbol, IsVtaTypeVar False)
        , ("ordering", Just kindOrdering, IsVtaTypeVar False)
        ] [] []
        [ FunctionalDependency [0, 1] [2]
        ] True)
    ...
    , (primSubName C.moduleSymbol "Cons", makeTypeClassData
        [ ("head", Just kindSymbol, IsVtaTypeVar False)
        , ("tail", Just kindSymbol, IsVtaTypeVar False)
        , ("symbol", Just kindSymbol, IsVtaTypeVar False)
        ] [] []
        [ FunctionalDependency [0, 1] [2]
        , FunctionalDependency [2] [0, 1]
        ] True)
...
primIntClasses =
  M.fromList
    ...
    [ (primSubName C.moduleInt "Add", makeTypeClassData
        [ ("left", Just tyInt, IsVtaTypeVar False)
        , ("right", Just tyInt, IsVtaTypeVar False)
        , ("sum", Just tyInt, IsVtaTypeVar False)
        ] [] []
        [ FunctionalDependency [0, 1] [2]
    ...
    , (primSubName C.moduleInt "Mul", makeTypeClassData
        [ ("left", Just tyInt, IsVtaTypeVar False)
        , ("right", Just tyInt, IsVtaTypeVar False)
        , ("product", Just tyInt, IsVtaTypeVar False)
        ] [] []
        [ FunctionalDependency [0, 1] [2]
        ] True)
    ...
    , (primSubName C.moduleInt "ToString", makeTypeClassData
        [ ("int", Just tyInt, IsVtaTypeVar False)
        , ("string", Just kindSymbol, IsVtaTypeVar False)
        ] [] []
        [ FunctionalDependency [0] [1]
        ] True)
    ]
...
primTypeErrorClasses =
  M.fromList
    ...
    [ (primSubName C.typeError "Fail", makeTypeClassData
        [("message", Just kindDoc, IsVtaTypeVar False)] [] [] [] True)
