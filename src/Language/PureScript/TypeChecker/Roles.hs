  ...
  walk btvs t
    ...
    , not $ null t2s =
        case t1 of
          ...
          --
          -- If the role is nominal,
          -- mark all free variables in the argument as nominal also,
          -- since they cannot be coerced if the argument's nominality is to be preserved.
          --
          -- If the role is representational, recurse on the argument,
          -- since its use of our parameters is important.
          --
          -- If the role is phantom, terminate,
          -- since the argument's use of our parameters is unimportant.
