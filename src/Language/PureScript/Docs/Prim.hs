...
coercible = primClassOf (P.primSubName "Coerce") "Coercible" $ T.unlines
  ...
  , ""
  , "First, Coercible is an equivalence relation. It obeys reflexivity,"
  , "any type has the same representation as itself, symmetry, pairs of"
  , "types can be coerced both ways, and transitivity, two types can be"
  , "coerced if they are coercible to the same type:"
  , ""
  , "    instance coercibleReflexive :: Coercible a a"
  , "    instance coercibleSymmetric :: Coercible a b => Coercible b a"
  , "    instance coercibleTransitive :: (Coercible a b, Coercible b c) => Coercible a b"
  , ""
